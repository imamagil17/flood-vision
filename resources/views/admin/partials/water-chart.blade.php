<div class="bg-white/70 backdrop-blur-md rounded-3xl p-6 shadow-sm border border-slate-200/60 flex flex-col h-full relative group w-full min-h-[480px]">
    ...
    <div id="chartSkeleton" class="absolute inset-0 top-28 bottom-6 left-6 right-6 animate-pulse flex items-end justify-between gap-2 pb-8">
    ...
    <div class="flex-1 h-0 w-full overflow-x-auto relative opacity-0 transition-opacity duration-500" id="chartContainer">
        <div class="min-w-[1000px] h-full pb-2">
